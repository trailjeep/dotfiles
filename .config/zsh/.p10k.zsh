# Generated by Powerlevel10k configuration wizard on 2023-06-14 at 06:13 EDT.
...
# 2 lines, dotted, no frame, white-ornaments, compact, many icons, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%Y-%m-%d %I:%M:%S %p}' #'%D{%I:%M:%S %p}'
