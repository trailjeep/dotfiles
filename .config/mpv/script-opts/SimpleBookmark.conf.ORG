...
list_filter_jump_keybind=[ ["b", "all"], ["B", "all"], ["k", "keybinds"], ["K", "keybinds"], ["!", "/:group%Watch Later%"], ["@", "/:group%Pets%"], ["SHARP", "/:group%Comedy%"], ["$", "/:group%Hardware%"], ["%", "/:group%Software%"], ["^", "/:group%Health%"], ["&", "/:group%Food%"], ["*", "/:group%Science%"], ["(", "/:group%Music%"], ["r", "recents"], ["R", "recents"], ["d", "distinct"], ["D", "distinct"], ["f", "fileonly"], ["F", "fileonly"] ]
...
groups_list_and_keybind=[ ["Watch Later", "ctrl+1", "ctrl+!"], ["Pets", "ctrl+2", "ctrl+@"], ["Comedy", "ctrl+3", "ctrl+#"], ["Hardware", "ctrl+4", "ctrl+$"], ["Software", "ctrl+5"], ["Health", "ctrl+6"], ["Food", "ctrl+7"], ["Science", "ctrl+8"], ["Music", "ctrl+9"] ]
...
filters_and_sequence=["all", "keybinds", "groups", "/:group%Watch Later%", "/:group%Pets%", "/:group%Comedy%", "/:group%Hardware%", "/:group%Software%", "/:group%Health%", "/:group%Food%", "/:group%Science%", "/:group%Music%", "protocols", "fileonly", "titleonly", "timeonly", "playing", "keywords", "recents", "distinct", "keybinds%+%groups", "all%-%groups%-%keybinds"]
